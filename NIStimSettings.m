...
elseif strcmp(S.ni.description,'National Instruments USB-6343')
    disp(['Applying settings for ' S.ni.description])
    S.ni.chin = [1 2 3]; %[1 2 3 18 19 22];           %[1 2 3]; %  %[18 19 22 23]; % %  % % %
    S.ni.chilabel = {'Current','Voltage','Trigger','X','Y','Z'}; %{'Current','Voltage','Trigger'};
    S.ni.chout = [0 1 2]; % 0 out is always trigger
    S.ni.rate = 20e3;
    S.ni.voltrange = [-0.5 0.5; -0.5 0.5; -0.5 0.5;]; %[-1 1; -10 10; -10 10; -10 10; -10 10; -10 10;];
    S.ni.inputtype = {'Differential','Differential','Differential'}; %{'SingleEnded','SingleEnded','SingleEnded','SingleEnded','SingleEnded','SingleEnded'}; %{'SingleEnded','Differential','SingleEnded','SingleEnded','SingleEnded','SingleEnded'}; %{'SingleEnded','Differential','SingleEnded'};
