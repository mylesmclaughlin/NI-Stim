function P = NIStimPreset_tACS_PhaseLowFreq


%% - Setup the marco struture -

% Setup the macro variables
P.preset.basefilename = 'RatTACSPhaseLowFreq-'; % set base file name
...
subThresAmp = 0.2;
subThresFreq = 2.5; % [1.25 2.5 5 10 20 40 80 160]  [0.5 1 2 4 8 16 32 64];
subThresDC = 0;
%subThresNcycles = 5;
subThresNumberreps = 3;
subThresDurOn = 4; %subThresNcycles*(1/subThresFreq);
subThresDurOff = 0;
...
supThresAmp = 3.5;
supThresFreq = 10;
supThresBurstdur = (subThresDurOn-1/subThresFreq)*1000;
