...
M(1).macro.basefilename = 'RatSinBurst-'; % set base file name
...
% Stimulus loop
for n = 1:length(freqvec)
    M(n).stim.seqname = ['NoAMSINFreq' num2str(freqvec(n))];
    M(n).stim.stim = 0;
